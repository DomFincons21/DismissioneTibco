({  
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
              ...
              //DF  component.set('v.pods',returnedValue);
                ...
                console.log("selectedPod",returnedValue.data[0].pods.IdPod);
                if(TaxCode != null || VatNumber != null)
                    helper.getAccountId(component,event,helper,TaxCode,VatNumber);
            }
        });
    ...
    FiltraClick : function(component, event, helper) {
